...
export default function ToggleSwitch() {
  ...
  return (
    <div className="text-black bg-transparent backdrop-blur-md mx-2  lg:mx-10 xl:mx-50 px-2">
      <div className="flex justify-end md:justify-start pb-2 ">
        <div className="  flex items-center space-x-2 relative text-black overflow-hidden mt-2 lg:pb-0 md:pb-0 sm:pb-0">
          {/* NZ Flag */}
          <img
            src="/nzFlag.svg"
